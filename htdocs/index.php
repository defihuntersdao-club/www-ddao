...
<body class="dark-theme">
	<header>
		...
		<div class="top-header d-flex">
			...
			<div class="top-header__info  d-flex">
				<a href="#" class="top-header__poligon">
				...
				<div class="top-header__wallet">
					<div class="top-header__wallet-bl">
						...
						<div class="top-header__wallet-id">
							0хС60В...9се8
				...
				<div class="menu-block">
					...
					<div class="menu-block__links">
						...
						<a href="#" class="menu-block__link menu-block__link_language">
	...
	<section class="page">
		<div class="container">
			<div class="title-bl">Pools Overview</div>
			<div class="top-line d-flex">
				<div class="top-views d-flex">
					<div class="search">
						<input type="text" class="search-input" name="search" placeholder="Search Farms">
					</div>

					<div class="top-views__wrap d-flex">
						<div class="views d-flex">
							<a href="#" class="views__link grid ">
							...
							<a href="#" class="views__link line active">
								<svg width="18" height="15" viewBox="0 0 18 15" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="add-position">
					<a href="#" class="add-position__btn">
						+ New Position
					</a>
					<div class="add-position__block">
			...
			<div class="wrapper">
				<div class="line-wrap">
					<div class="line-item">
						<div class="line-item__top d-flex">
						...
						<div class="line-item__bottom d-flex">
							<div class="line-item__button">
								<a href="#" class="art-button-2">
									Claim
								</a>
							</div>
							<div class="line-item__info">
								<div>
									...
									<div class="value">xxxxxxxxxxxxxxxxxxxxxxxxxxxx</div>
								</div>
								<div>
									<div class="label">DDAO on contract:</div>
									<div class="value">xxxxxxxxxxxxxxxxxxxxxxxxxxxx</div>
								</div>
								<div>
					...
					<div class="line-item coming-soon">
						<div class="line-item__top d-flex">
							<div class="line-item__title">
								Seed
